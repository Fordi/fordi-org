...
const I18N = createI18nContext({
  ...
  fetchLanguage: (language) => fetch(`./api/i18n/${language}`).then((r) => r.json()),
});

export const useI18n = () => useContext(I18N);

export const I18NSub = ({ messageKey, subs }) => useI18n()({ raw: [messageKey] }, ...subs);

export const reviveI18n = (_, value) => {
