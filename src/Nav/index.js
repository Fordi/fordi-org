    ...
    <div className={joinClass(styles.nav, styles[`nav-${selected}`])}>
        ...
        <div className={styles.controls}>
            ...
            <span className={styles.resume}>
                {'Resume: '}
                <ExtLink className={joinClass('button--text', styles.button)} href={docx}>Word</ExtLink>
                {' | '}
                <ExtLink className={joinClass('button--text', styles.button)} href={md}>Text</ExtLink>
            </span>
            <button
                type="button"
                className={joinClass(
